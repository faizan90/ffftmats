...
class FFTMASAAlgLagNthWts(GTGAlgLagNthWts):
    ...
    @GTGBase._timer_wrap
    def _set_lag_nth_wts(self, idxs_sclr):
...
class FFTMASAAlgLabelWts(GTGAlgLabelWts):
    ...
    @GTGBase._timer_wrap
    def _set_label_wts(self, idxs_sclr):
...
class FFTMASAAlgAutoObjWts(GTGAlgAutoObjWts):
    ...
    @GTGBase._timer_wrap
    def _set_auto_obj_wts(self, idxs_sclr):

...
def main():
    ...
    in_file = Path(rf'sims{file_suff}.csv')
    ...
    # if False:
        ...
        out_fig_name_pecop = f'ecop_props{file_suff}.png'
        out_fig_name_pwr = f'cumm_pwr{file_suff}.png'
        out_fig_name_pwr_ranks = f'cumm_pwr{file_suff}_ranks.png'
        ...
        out_fig_name_pwr_ranks = 'cumm_pwr_norms_ranks.png'
    #==========================================================================

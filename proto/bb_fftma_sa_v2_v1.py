...
def run_sa(args):
    ...
    for i in range(n_iters):
        if not i:
            ...
            idx_rnd_1, idx_rnd_2 = np.random.randint(
                low=corr_ftn_range,
                high=norms_iter.shape[0] - corr_ftn_range,
                size=2)

            # TODO: Put a limit here.
            while idx_rnd_1 == idx_rnd_2:
                idx_rnd_2 = np.random.randint(
                    low=corr_ftn_range,
                    high=norms_iter.shape[0] - corr_ftn_range)
    ...
    return (
        ...
        obj_val_global,
        temp,
        norms[corr_ftn_range:-corr_ftn_range])
...
def main():
    ...
    out_dir = Path(r'fftma_sa_v2_v1_04_hourly')
    #==========================================================================

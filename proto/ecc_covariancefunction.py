...
def main():
    ...
    c1 = type_mat(h,Range=a,v=1.0)
    c2 = type_hol(h,Range=a)
    c3 = type_exp(h,Range=a)
    c4 = type_gau(h,Range=a)
    c5 = type_sph(h,Range=a)
    c6 = type_lin(h,Range=a)
